...
This project aims to use Python 3, Flask, and Connexion to build useful REST APIs that can include input and output validation and provide Swagger documentation as a bonus. 
